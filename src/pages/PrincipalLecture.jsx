...
function PrincipalLecture() {
  ...
  // Load reports, courses, and ratings - ADDED DATABASE CONNECTION
  useEffect(() => {
    loadReportsFromDB();
    loadCoursesFromDB();
    loadRatingsFromDB();
  ...
  // Calculate unique lecturers supervised - UNCHANGED
  const lecturersSupervised = [...new Set(courses.map((c) => c.lecturerName))]
    .length;
  ...
  // Handle delete lecturer report - ADDED DATABASE CONNECTION
